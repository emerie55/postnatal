...
<head>
 <link rel="icon" href="img/faviconn.png">
  ...
  <title>Edit/Delete exam questions - Admin</title>
...
<br>
 ...
 <form action="" method="POST" class="user">
  ...
  <?php
    ...
    $geti=$_GET['id'];
    $queryo=mysqli_query($con,"select * from ex_am_s where id = '".$geti."' ");
...
$senddata2 = mysqli_query($con,"UPDATE ex_am_s SET question='".mysqli_real_escape_string($con,$que)."',
...
echo "<script> location.replace('viewexams.php')</script>";  
  }
  else{
	...
	<!-- delete question -->
	 <?php
	  if(isset($_POST['del'])){
		 ...
		 $geto=$_GET['id'];
		$queryo3=mysqli_query($con,"delete from ex_am_s where id = '".$geto."' ") or die(mysqli_error($con));
